        ...
        edits.append(
            {
                ...
                "negative_prompt": str(item.get("negative_prompt", "")).strip(),
                "use_angle_lora": bool(item.get("use_angle_lora", False)),
                "use_lightning": bool(item.get("use_lightning", False)),
...
def call_edit_generate(
    ...
    payload = {
        ...
        "use_angle_lora": bool(edit.get("use_angle_lora", False)),
        "angle_lora_scale": float(edit.get("angle_lora_scale", 1.0)),
        "use_lightning": bool(edit.get("use_lightning", False)),
